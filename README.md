...
- Разработка ML-модели для идентификации клиентов, планирующих расторгнуть договор, с целью их удержания.
- Стек: Python, CatBoost, LightGBM, Pipelines, ROC-AUC.
...
- HR-аналитика: предсказание увольнений
- Суть: Прогнозирование лояльности сотрудников и интерпретация причин ухода с помощью SHAP-значений.
- Стек: Scikit-learn, SHAP, Phik, EDA.
...
- Определение наиболее прибыльного региона добычи нефти с оценкой финансовых рисков методом Bootstrap.
- Стек: Scikit-learn, Bootstrap, статистический анализ.
...
Оценка рыночной цены авто с пробегом на основе градиентного бустинга.

2. Проект "Вольный луг"
...
4. Статистический анализ данных аренды самокатов GoFast
https://github.com/nastasii0/nastasii0.github.io/blob/85558cc2b1c62b5da8b040bdac18c2e5b6056017/statistical_analysis.ipynb
Анализ поведения пользователей и проверка продуктовых гипотез для аренды самокатов.
